...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    @Override
    public List<Map<String, Object>> getTeacherWeeklySchedule(Long teacherId,
            String academicYear,
            Integer semester) {
        ...
        return schedules.stream()
                ...
                .map(entry -> {
                    ...
                    daySchedule.put("dayOfWeek", entry.getKey());
                    daySchedule.put("dayName", entry.getKey().name());
                    daySchedule.put("schedules", entry.getValue());
                    return daySchedule;
                })
                .collect(Collectors.toList());
    }
    ...
    @Override
    public List<Map<String, Object>> getClassroomWeeklySchedule(Long classRoomId,
            String academicYear,
            Integer semester) {
    ...
    @Override
    public List<ScheduleResponse> generateScheduleSuggestions(Long classRoomId, Long subjectId,
    ...
    @Override
    public void generateScheduleChangeNotifications(Long scheduleId,
            String changeType,
            String changeDescription) {
        // Implementation for generating schedule change notifications
        // This would typically involve sending notifications to affected parties
        log.info("Generating schedule change notifications for schedule: {}, change: {}, description: {}",
                scheduleId, changeType, changeDescription);
    }
