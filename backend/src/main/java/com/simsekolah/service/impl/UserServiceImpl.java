...
import com.simsekolah.dto.request.CreateUserRequest;
...
public class UserServiceImpl implements UserService {
    ...
    public Page<UserResponse> searchUsers(String searchTerm, Pageable pageable) {
        ...
        // Use searchUsers method from repository for combined name/username/email search
        return userRepository.searchUsers(searchTerm, null, null, pageable)
            .map(UserResponse::from);
    }
