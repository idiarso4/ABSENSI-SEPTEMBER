...
public class DataInitializerService {
    ...
    public void initializeTestData() {
        System.out.println("ðŸš€ Starting test data initialization...");
        ...
        try {
            ...
            System.out.println("ðŸŽ‰ Test data initialization completed successfully!");
            
        } catch (Exception e) {
            System.err.println("âŒ Error initializing test data: " + e.getMessage());
            e.printStackTrace();
        }
    }

    public void clearAllData() {
        System.out.println("ðŸ—‘ï¸ Clearing all test data...");
