...
public interface AttendanceService {
    ...
    /**
     * Get students pending attendance for a teaching activity
     */
    List<StudentMiniResponse> getStudentsPendingAttendance(Long teachingActivityId);

    /**
     * Get attendance history for an attendance record
     */
    List<AttendanceHistoryResponse> getAttendanceHistory(Long attendanceId);

    /**
     * Get attendance history by teacher
     */
    Page<AttendanceHistoryResponse> getHistoryByTeacher(Long teacherId, Pageable pageable);

    /**
     * Get attendance history statistics
     */
    Page<AttendanceHistoryStatResponse> getAttendanceHistoryStats(Pageable pageable);

    /**
     * Revert attendance from history
     */
    AttendanceResponse revertAttendanceFromHistory(Long historyId);

    /**
     * Get attendance statistics by class room
     */
    ClassAttendanceStatsResponse getAttendanceStatsByClassRoom(Long classRoomId, int year, int month);
