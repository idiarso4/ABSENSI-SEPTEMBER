...
public class ExtracurricularAttendanceResponse {
     ...
     */
    public static ExtracurricularAttendanceResponse from(com.simsekolah.entity.ExtracurricularAttendance attendance) {
        if (attendance == null) {
            return null;
        }
        ...
        if (attendance.getActivity() != null) {
            com.simsekolah.entity.ExtracurricularActivity activity = attendance.getActivity();
        ...
        if (attendance.getStudent() != null) {
            com.simsekolah.entity.Student student = attendance.getStudent();
