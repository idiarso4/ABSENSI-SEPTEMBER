...
public class AttendanceResponse {
    ...
    public static class TeachingActivityInfo {
        ...
        public TeachingActivityInfo(com.simsekolah.entity.TeachingActivity teachingActivity) {
    ...
    public static class StudentInfo {
        ...
        public StudentInfo(com.simsekolah.entity.Student student) {
    ...
    public static class SubjectInfo {
        ...
        public SubjectInfo(com.simsekolah.entity.Subject subject) {
    ...
    public static class ClassRoomInfo {
        ...
        public ClassRoomInfo(com.simsekolah.entity.ClassRoom classRoom) {
    ...
    public static class UserInfo {
        ...
        public UserInfo(com.simsekolah.entity.User user) {
            this.id = user.getId();
