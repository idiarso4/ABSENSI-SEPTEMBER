...
/**
 * Request DTO for creating a new PKL attendance record
 */
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CreatePklAttendanceRequest {
    ...
    @Builder.Default
    private PklAttendance.AttendanceStatus status = PklAttendance.AttendanceStatus.PRESENT;
